...
class FairseqGCNModel(BaseFairseqModel):
    """Base class for encoder-decoder models."""
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, adj_arc_in, adj_arc_out,
                adj_lab_in, adj_lab_out, mask_in, mask_out, mask_loop, sent_mask):
        encoder_out = self.encoder(src_tokens, src_lengths, adj_arc_in, adj_arc_out,
                adj_lab_in, adj_lab_out, mask_in, mask_out, mask_loop, sent_mask)
        decoder_out = self.decoder(prev_output_tokens, encoder_out)
        return decoder_out
