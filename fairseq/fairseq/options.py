...
def get_training_parser(default_task='translation'):
    parser = get_parser('Trainer', 'gcn_wikicatsum')
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--skip-invalid-size-inputs-valid-test', action='store_false',
                       help='ignore too long or too short lines in valid and test set')
    group.add_argument('--max-tokens', default=4000, type=int, metavar='N',
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--save-dir', metavar='DIR', default='checkpoints/train',
...
def add_model_args(parser):
    ...
    group.add_argument(
        '--arch', '-a', default='fconv_gcn_wikicatsum', metavar='ARCH', required=False,
        # '--arch', '-a', default='fconv_wikicatsum', metavar='ARCH', required=False,
        choices=ARCH_MODEL_REGISTRY.keys(),
        help='model architecture: {} (default: fconv_gcn_wikicatsum)'.format(
