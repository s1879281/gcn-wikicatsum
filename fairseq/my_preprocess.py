...
def get_parser():
    ...
    parser.add_argument('--trainpref', metavar='FP', default='text/train/train', help='target language')
    parser.add_argument('--validpref', metavar='FP', default='text/valid/valid', help='comma separated, valid language prefixes')
    parser.add_argument('--testpref', metavar='FP', default='text/test/test', help='comma separated, test language prefixes')
    parser.add_argument('--destdir', metavar='DIR', default='prepro', help='destination dir')
